...
PLAN_FILE="${STACK_DIR}/terraform-apply.tfplan"
PLAN_JSON="${STACK_DIR}/terraform-apply.tfplan.json"
CONVERGENCE_LOG="${STACK_DIR}/terraform-convergence.log"
...
diagnostics() {
  ...
  echo
  echo "============================================================"
  echo "=== TERRAFORM APPLY VALIDATION DIAGNOSTICS ==="
  echo "============================================================"
  ...
  echo "FLOCI_TERRAFORM_APPLY_VALIDATION=FAIL"
  exit "$exit_code"
}
...
echo "============================================================"
echo "=== FLOCI TERRAFORM APPLY AND FUNCTIONAL VALIDATION ==="
echo "============================================================"
...
echo
echo "=== 3. FORMAT, INITIALIZE, AND VALIDATE ==="
...
echo
echo "=== 4. CREATE AND ASSERT SAVED PLAN ==="
...
if creates != expected:
    raise SystemExit(
        ...
        f"Actual:   {sorted(creates)}"
    )

print("TERRAFORM_CREATE_PLAN_EXACT_MATCH=PASS")
print(f"TERRAFORM_CREATE_COUNT={len(creates)}")
PY

echo
echo "=== 5. APPLY SAVED PLAN ==="
...
echo
echo "=== 9. VERIFY FUNCTION AND EVENT-SOURCE MAPPING ==="
...
echo
echo "=== 10. SEND UNIQUE SQS MESSAGE ==="

ORDER_ID="tf-order-$(date -u +%Y%m%dT%H%M%SZ)-$$"
...
echo
echo "=== 11. WAIT FOR DYNAMODB SIDE EFFECT ==="
...
echo
echo "=== 12. VERIFY DOCKER-BACKED LAMBDA EXECUTION ==="
...
echo
echo "=== 13. FINAL RESOURCE READ-BACK ==="
...
echo
echo "============================================================"
echo "FLOCI_TERRAFORM_APPLY_VALIDATION=PASS"
echo "ORDER_ID=${ORDER_ID}"
echo "============================================================"
